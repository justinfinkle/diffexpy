...
def check_enrichment(study_fn, pop_fn, assoc_fn, print_summary=False, save_summary = True, savepath=None, obo_dag=None):
    ...
    if save_summary:
        ...
        g.save_summary(savepath, min_ratio=min_ratio, indent=opts.indent, pval=opts.pval)
...
if __name__ == "__main__":
    ...
    studypath = '../clustering/go_enrichment/20151002_binary_clusters_0.05/KO/'
    ...
    cluster_enrichment(studypath, population, association, studypath, obo_dag)
    sys.exit()

    study = "../data/ko0_wt0_de_expressed_genes.txt"
    population = "../data/goa_data/filtered_genes.txt"
    association = "../data/goa_data/gene_association"
    obo = '../data/goa_data/go-basic.obo'
    obo_dag = GODag(obo_file=obo)
